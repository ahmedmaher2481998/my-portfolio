        ...
        >
          ...
          <Box mt={10}>
            ...
            >
              ...
              >
                this course helped me fall in love with programming ,and showed my what i can do if
                learned more , i love the problem solving part and the programmatic puzzles using C
                and python
              </Course>

              <Course title="The odin project" icon={<FaGlobe />}>
                Here i learned Html ,Css ,Responsive Design,and javaScript fundamentals,and built a
                lot of stuff like calculator and rock paper scissors game,multiple page website and
              ...
              <Course title="App Academy Full stack course " icon={<IoIosAppstore />}>
                ...
                own, i also learned about the redux pattern and how to use global state manger like
                redux or X-state or else ...
              </Course>
              ...
              <Course title="Next js learn platform" icon={<GiBookshelf />}>
                ...
                fundamentals,then learned about SSR,SSG, and the meaning of hydration and different
                other concepts, i used next js to build this portfolio website .
              </Course>
            </Stack>
          </Box>
        </Box>
